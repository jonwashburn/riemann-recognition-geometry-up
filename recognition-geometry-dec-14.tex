...
At the time of writing, \texttt{RiemannRecognitionGeometry/} consists of 37 project modules (17{,}082 lines), with 11 explicit \texttt{axiom} declarations and one remaining \texttt{sorry} (in \texttt{RiemannRecognitionGeometry/ExplicitFormula/Caratheodory.lean}); see the Appendix and the Route~3 addendum for details.
...
\texttt{Caratheodory.lean} & 642 \\
\texttt{Cayley.lean} & 99 \\
\texttt{CayleyBridge.lean} & 100 \\
\texttt{Concrete.lean} & 58 \\
\texttt{Defs.lean} & 62 \\
\texttt{HilbertRealization.lean} & 852 \\
\texttt{Lagarias.lean} & 150 \\
\texttt{Li.lean} & 126 \\
\texttt{MainRoute3.lean} & 239 \\
\texttt{MathlibBridge.lean} & 153 \\
\texttt{MulConvolution.lean} & 216 \\
\texttt{Route3FubiniTonelliLemmas.lean} & 93 \\
\texttt{Route3HypBundle.lean} & 101 \\
\texttt{Route3Targets.lean} & 55 \\
\texttt{WFunctionals.lean} & 71 \\
\texttt{WeilFunctionals.lean} & 69 \\
...
\noindent
\textbf{Current Lean status (this repository)}: 11 explicit \texttt{axiom} declarations and 1 remaining \texttt{sorry} (in \texttt{ExplicitFormula/Caratheodory.lean}).
...
\begin{itemize}
    ...
    \emph{Lean module inventory (20 files, \texttt{RiemannRecognitionGeometry/ExplicitFormula/}):}
    ...
    \texttt{ArithmeticJ}, \texttt{Cayley}, \texttt{CayleyBridge}.
